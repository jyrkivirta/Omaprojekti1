...
const Esineet = (props) => {
    ...
    useEffect(()=>{
        async function haeDataa(){
            let result = await axios('https://api.huuto.net/1.1/categories/'+props.id+'/items?area='
            +valittuPaikkakunta+'&words='+etsi
            )
            //console.log(result)
    ...
    return (<div>
        ...
        <input onChange={haeSanalla()=>(event)}>Hae sanalla</input>
